<?php
    if(empty(@$result)){
        ...
        foreach ($result as $key => $value) {
            ?><tr>
                <td><button class="btn btn-sm  btn-danger btn-to-edit delete_row" data-key="<?=@$key?>" data-id="<?=@$value->ID?>" data-oopid="<?=@$value->Order_payment_ID?>" data-amount="<?=@$value->Amount?>"><i class="fa fa-trash"></i></button></td>
