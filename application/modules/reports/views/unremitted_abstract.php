            ...
            <div class="box-body">
                <div>
                                ...
                                <table width="100%" class="table table-borderless table-bord"  style="font-size: 12px;">
                                    <?php
                                        ...
                                        foreach ($data as $key => $value) {
                                            ?><tr><td><?=@$value->Accountable_form_number?></td></tr><?php
                            ...
                            <div class="box-body">
                                ...
                                <table>
                                    <?php
                                        ...
                                        ?><tr><td style="width:20%;"></td><td style="width:20%; font-weight:bold; font-size:17px; color:red;"><?=number_format($TotalAmount, 2)?></td></tr><?php
                                    ?>
                                </table>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="box-body">
                            <div class="box-body">
                                <button class="btn btn-primary btn-flat btn-md"> <i class="fa fa-print"></i> Print Abstract </button>
                            </div>
                        </div>
                    </div>
                </div>
