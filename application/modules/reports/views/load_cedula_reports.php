...
<div class="row bodys">   
    <div class="box-footer">          
        <form action="<?php echo base_url()?>reports/service/reports_service/export_cedula_reports" method="post">
            ...
            ?>
            <button type="submit" style="margin-left: 0.5%" class="btn  btn-success"><i class="fa fa-download"></i> Download </button>
        </form>
    </div>    
</div>
<button class="btn  btn-primary" id="cedula_remittance"><i class="fa fa-money"></i> Remittance </button>