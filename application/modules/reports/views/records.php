                    ...
                    <div class="row">
                        <div class="box-body">
                            <div class="box-body">
                                    ...
                                    <tr>
                                        ...
                                        <td width="50%">
                                            <table width="100%" class="table table-borderless table-bord">
                                                ...
                                                <tr>
                                                    <p align="center" class="summary-of">( <?=strtoupper($ReportType->OR_for)?> )</p>
                                                </tr>
                                            </table>
                                        </td>
                                        <td width="30%" class="table-bord" style="font-size: 12px;">
                                            <table>
                                                <tr>                                                    
                                                    <p align="left" class="remit_no">Remittance No: <?=$remit_number?></p>
                                                    <input type="hidden" id="remitNumber" value="<?=$remit_number?>">
                                                </tr>
                                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <p class="acct"> Acct. Form ( <?=@$ColType->Accountable_form_origin?> ) </p>
                                    </td>
                                </tr>
                                <div class="border-line"></div>
                                ...
                                <table width="100%" class="" style="font-size: 12px;">
                                    ...
                                    $PAn = '';
                                    $PDate = '';
                                    foreach ($remit_rec as $key => $value) {
                                    ?>
                                    <?php
                                    ...
                                    ?>
                                     <tr>
                                        <td style="width: 15%;">
                                            <?php
                                               if($PAn === $value->Accountable_form_number){
                                                echo '';
                                               } else {
                                                echo $value->Accountable_form_number;
                                               }
                                               $PAn = $value->Accountable_form_number;
                                            ?>
                                        </td>
                                        <td style="width: 20%;">
                                            <?php
                                               if($PDate === $value->Date_paid){
                                                echo '';
                                               } else {
                                                echo substr( $value->Date_paid, 0, 10);
                                               }
                                               $PDate = $value->Date_paid;
                                            ?>
                                        </td>
                                        <td style="width: 20%;"><?= $value->Cancelled == 0 ? strtoupper($value->Payor) : "*VOIDED*"?></td>
                                        <td>
                                            <?php if($value->Particular_ID == 451){ ?>
                                                <td style="width: 35%;"><?= $value->Cancelled == 0 ? strtoupper($value->Bus_tax_particular) : "*VOIDED*"?></td>
                                            <?php } else{ ?>
                                                <td style="width: 35%;"><?= $value->Cancelled == 0 ? strtoupper($value->Particular) : "*VOIDED*"?></td>
                                            <?php }?>
                                        </td>
                                        <td align="right"><?= $value->Cancelled == 0 ? number_format($value->Amount,2) : "0.00"?></td>
