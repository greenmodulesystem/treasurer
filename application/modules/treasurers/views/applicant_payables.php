...
<?php } else { 
    ...
    <tr style="border:2px solid gray;">
        <td style="width:12.5%;">&emsp;</td><td style="width:12.5%;">&emsp;</td>
        <td style="width:12.5%;">&emsp;</td><td style="width:12.5%;">&emsp;</td>
        <td style="width:12.5%;">&emsp;</td><td style="width:12.5%;">&emsp;</td>
        <!-------------------------------------- 02-19-2020 -------------------------------------->
    ...
    <tr>
        ...
        <td style="border-left:2px solid gray;vertical-align:middle" class="text-right"
            colspan="2"><b>Total Cash Payment :</b>
        </td>
    ...
    <tr>
        ...
        <td style="border-left:2px solid gray;vertical-align:middle" class="text-right"
            colspan="2"><b>Total Non Cash Payment :</b>
        </td>
    ...
    <tr>
        ...
        <td style="border-left:2px solid gray;vertical-align:middle" class="text-right"
            colspan="2"><b><font color="red">Credits :</font></b>
        </td>
    ...
    <tr>
        ...
        <td style="border:2px solid gray;vertical-align:middle" class="text-center success"
            colspan="2"><b>Pay For :</b>
            <input type="checkbox" id="Pay_Q1" disabled <?=$Q1 == 0 ? '' : 'checked';?>
                class="check_qtr"><b>Q1</b>&ensp;
            ...
            <input type="checkbox" id="Pay_Q4" <?=$Q4 == 0 ? 'disabled' : ($Q1 == 0 && 
                $Q2 == 0 && $Q3 == 0 ? 'checked' : '');?>
                class="check_qtr"><b>Q4</b>
        </td>
        <td style="border-left:2px solid gray;vertical-align:middle" class="text-right"
            colspan="2"><b><font color="red">Cash Change :</font></b>
        </td>
    ...
    <tr>
        ...
        <td style="border-left:2px solid gray;vertical-align:middle" class="text-right"
            colspan="2"><b><font color="red">Balance Unpaid :</font></b>
        </td>
    ...
    <tr>
        ...
        <td class="text-center C_No" style="vertical-align:middle" id="OR_td"
            data-target="#OR_modal" data-toggle="modal" data-keyboard="false" data-backdrop="static"> <!-- 01-15-2020 -->
            <font face="arial black" size="4"><input style="width:150px;border:none;outline:none" 
                class="input-md text-center" id="OR_number" value="0000000" disabled>
            </font>
        </td>
        <td class="text-left" style="border-right:2px solid gray;vertical-align:middle" colspan="2">
            ...
            <span class="text-left" id="Status"><font face="arial black" size="4" color="green">ONLINE</font></span>
        </td>
        <td style="border-top:2px solid gray;">
            <button class="btn flat btn-default form-control" id="Cash_button" data-target="#Cash_modal" 
                data-toggle="modal" data-keyboard="false" data-backdrop="static">F9 - CASH</button>
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input id="Cash_amount" class="form-control input-sm text-right" 
                                placeholder="0.00" type="number" step="0.01" autofocus>
                        </div>
                        <div class="modal-footer">
                            <button class="btn btn-primary btn-sm flat modal_submit"
                                data-dismiss="modal"><i class="fa fa-arrow-right"></i>&ensp;Submit
                            </button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-body">    
                            <div class="form-group has-feedback">
                                ...
                                <input id="OR_entry" class="form-control input-sm text-right" 
                                    placeholder="0000000" type="text" autofocus>
        ...
        <td style="border-top:2px solid gray;border-right:2px solid gray;">
            <button class="btn flat btn-default form-control" id="Check_button" data-target="#Check_modal" 
                data-toggle="modal" data-keyboard="false" data-backdrop="static">F10 - CHECK</button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row form-inline">
                                ...
                                <select id="Bank_name" class="form-control input-sm" autofocus
                                    style="width:56%;float:right;margin-right:15px;">
                            ...
                            <div class="row form-inline">
                                ...
                                <input id="Check_no" class="form-control input-sm" type="text"
                                    placeholder="Check No.">
                            </div>
                            <div class="row form-inline">
                                <label class="text-right" style="width:38%;">Check Date :</label>
                                <input id="Check_date" class="form-control input-sm" type="text" 
                                    placeholder="Check Date">
                            </div>
                            <div class="row form-inline">
                                <label class="text-right" style="width:38%;">Enter amount :</label>
                                <input id="Check_amount" class="form-control input-sm text-right" 
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-primary btn-sm flat modal_submit" data-dismiss="modal"
                                id="Check_submit"><i class="fa fa-arrow-right"></i>&ensp;Submit
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <td style="border-top:2px solid gray;border-right:2px solid gray;">
            ...
            <button id="Open_receipt" style="display:none" data-target="#Receipt_modal" data-toggle="modal" 
                ...
                <div class="modal-dialog" style="width:425px;">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-primary btn-sm flat" id="Print_receipt" name="Print"
                                data-dismiss="modal"><i class="fa fa-print"></i>&ensp;Save Payment and Print
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <tr style="border-top:2px solid gray;" class="success">
        <td style="border-left:2px solid gray;border-right:2px solid gray;" 
            colspan="4"><b>Remarks :</b></td>
        <td style="border-right:2px solid gray;" colspan="4"><b>Check info :</b>
            <button class="btn btn-default btn-xs flat pull-right" id="Clear_check" 
                style="border:1px solid #555555"><b>Clear</b>
            </button>
        </td>
    </tr>
    ...
    <tr style="border-top:2px solid gray;"><td colspan="8"></td></tr>
...
<script language="javascript"> 
    ...
    var validate = function(){
        ...
        var stale = new Date();stale.setMonth(stale.getMonth()-3);stale.setDate(stale.getDate()-1);
